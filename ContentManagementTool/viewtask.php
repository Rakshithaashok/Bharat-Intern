...
<body>
        ...
        try {
          ...
          if ($execute) {
            echo "<script>
                    ...
                    window.open('/ProjectManagementTool/index.php', '_self');
                  </script>";
          } else {
            echo "<script>
  ...
  <footer id="footer">
    <div id="slideContainer">
      <div id="slide1">
        ...
        <div id="socialBtnContainer">
          ...
          <a href="https://instagram.com/rakshitha_0724?igshid=OGQ5ZDc2ODk2ZA=="><i class="fa-brands fa-instagram"></i></a>
          <a href="https://www.linkedin.com/in/rakshitha-ashok-0a04bb224/"></i></a>
        </div>
    ...
    <div id="developed">developed by @Rakshitha</div>
  </footer>
</body>
